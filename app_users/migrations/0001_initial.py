# Generated by Django 4.1.6 on 2023-02-11 09:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_freelancer', models.BooleanField(default=False, verbose_name='является фрилансером')),
                ('can_invite_referrals', models.BooleanField(default=False, verbose_name='может приглашать рефералов')),
                ...
                ('phone_number', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator(message="Номер телефона должен быть в формате: '+79012345678'.", regex='^\\+\\d{11,15}')], verbose_name='номер телефона')),
