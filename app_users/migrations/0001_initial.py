    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.SlugField(blank=True, max_length=55, unique=True, verbose_name='имя пользователя')),
                ...
                ('personal_number', models.BigIntegerField(blank=True, db_index=True, null=True, verbose_name='ИНН или персональный номер')),
                ...
                ('document_issued', models.CharField(blank=True, db_index=True, max_length=55, verbose_name='Когда и кем выдан')),
                ...
                ('is_core', models.BooleanField(db_index=True, default=False, verbose_name='входит в ядро')),
                ...
                ('bank_bic', models.BigIntegerField(blank=True, null=True, verbose_name='БИК банка')),
                ('bank_correspondent_account', models.BigIntegerField(blank=True, null=True, verbose_name='Корреспондентский счет банка')),
                ('payment_account', models.BigIntegerField(blank=True, null=True, verbose_name='Расчетный счет')),
